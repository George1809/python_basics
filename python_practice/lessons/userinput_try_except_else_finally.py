...
print(user_says)
nr_says = int(input("Enter a number:"))
print(nr_says, end="Wow")
print("")




'''Try / Except / Else / Finally - handling an exception when it occurs and telling
Python to keep executing the rest of the lines of code in the program'''
